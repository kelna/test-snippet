...
RUN username="selenium" && \
    ...
    adduser --uid 1000 --home "/home/$username" --gid 1000 --quiet --disabled-password --gecos "Mr. X $username User,,,"  $username && \
    usermod -p "aaxLE2Ou6vEQA" $username && \
    # echo 'selenium:polip' | chpasswd && \
